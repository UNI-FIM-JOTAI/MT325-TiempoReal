...
int8 k1,k2,k3,k4,k5,k6,k7,k8;
int8 l1,l2,l3,l4,l5,l6,l7,l8;
int cont;
int1 contar=0;
...
//*****************************************************************************
//PROGRAMA 8: Lectura ADC0 - FINITO
#ORG 0x14E0, 0x1605
void leer_ADC1()
{  
   setup_adc_ports(AN0_TO_AN3|vss_vdd);
   ...
   while(TRUE)
   {
      ...
      comando = 'D';
      valor2 = 8;
      for (k8=1;k8<250;k8++){for (l8=1;l8<250;++l8){}}
   }
}


//*****************************************************************************
// PROGRAMA 9: Mostrar Procesos
